...
class HomeScreenUI extends State<HomeScreen>{
  ...
  List<Contact>contacts =[
    Contact("John Doe", "johndoe@example.com","01563473476"),
    Contact("Jane Smith","janesmith@example.com","01634863653"),
    Contact("Allice Johnson", "allicejohnson@example.com","01845633333"),
    Contact("Sourov", "sourov@gmail.com","01965656588"),
  ];
